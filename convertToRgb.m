...
% Updated: 11/22/2023
%
% Subect: Function convert YCbCr Image data to RGB image data following the
% work of Xu and Kim in "Luminance Preserving Color Conversion for 24-bit
% RGB Displays"
%
function imdata = convertToRgb(imdata)

    % Get the original dimensions of the image [MxNx3]
    dims = size(imdata);

    % Permute the original image data so that the YCbCr channels are in the
